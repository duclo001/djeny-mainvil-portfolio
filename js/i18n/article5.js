...
i18nAjouter({
  ...
  en: {
    ...
    "article5-agent-case-p1": "Pandora faced strong growth in online sales and a surge in international customer requests. The company deployed an AI agent named Gemma, integrated into its CRM environment (Commerce Cloud + Data Cloud). The agent could answer product questions, recommend suitable items, handle some service requests, and handle interactions without human intervention.",
    ...
    "article5-emotion-p1": "Emotion AI (also called affective computing) aims to identify and interpret emotional signals from behavioral and sometimes biometric data such as voice, text, or facial expressions. In CRM, it can help detect frustration during a call, analyze the tone of an email, or measure overall sentiment from customer reviews.",
    ...
    "article5-xai-p2": "Explainability strengthens compliance, user trust, and audit quality. For SMEs, it can become a credibility lever with partners, investors, or institutions by demonstrating that AI use is controlled, responsible, and aligned with transparency requirements.",
    "article5-h2-7": "SMEs vs large organizations: the real strategic difference",
    "article5-sme-p1": "Choosing the right type of AI depends on context and strategic priorities. For SMEs, the most relevant approach is often progressive and focused on quick, measurable wins. Predictive AI is frequently the best starting point (revenue, churn, anomalies, demand), while generative AI can quickly boost productivity (writing, summaries, support, first-pass analysis).",
